...
export const rules = [
    {
        title: "Be respectful",
        description: "Treat others the way you want to be treated. Harassment, bullying, and hate speech are not tolerated on Quacky.",
    },
    {
        title: "No spam",
        description: "Do not post repetitive content, unsolicited promotions, or engage in coordinated inauthentic behaviour.",
    },
    {
        title: "No NSFW or inappropriate content",
        description: "Sexually explicit, pornographic, or sexually suggestive content is strictly prohibited.",
    },
    {
        title: "Do not share misinformation",
        description: "Do not share content that is widely known to be false or misleading, especially on health, safety, or political topics.",
    },
    {
        title: "Respect other's IP",
        description: "Credit creators when sharing their work. Do not claim others' content as your own.",
    },
    {
