...
export function Composer() {
  ...
  return (
    ...
    >
      <div
        className={cn(!canPost && "pointer-events-none blur-[2px] select-none")}
      >
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-2">
            <div
              className={cn(
                ...
                hasContent ? "h-28" : "h-10 group-has-[textarea:focus]:h-28"
              )}
            >
              {mode === "write" ? (
      ...
      {!canPost && (
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 rounded-md bg-card-primary/70 p-4 text-center">
          ...
          <p className="text-sm font-bold text-primary">Posting is Locked!</p>
